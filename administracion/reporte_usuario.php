...
<div class="row">
      <div class="col-lg-12">
       <div style="width: 94%; margin-left: 20px; position:relative;top: 40px;" >
          ...
          <div class="alert " 
 style="font-size: 15px; background:rgba(0, 125, 255, 0.5);"><center><i style="color:red; font-size: 25px;" class="fa fa-file-pdf-o" aria-hidden="true"></i><strong style="color:white;">REPORTES USUARIOS PDF</strong></center>
...
<br><br><br> 
 ...
 <!--   segunda columna-->
  ...
  <button   type="button" class="btn by  i" >
    <a  class="button7" style="  color: #FF7655;font-weight:bold; " href="reporte/pdf_administrador.php">ADMINISTRADORES</a>
      <img style="position: relative; top: -170px; left: 30px;" src="iconos/pdf.png" width="70"
title="click aqui"/>
  </button>
  ...
  <button   type="button" class="btn by  i" >
    <a  class="button8" style="  color: #FF7655;font-weight:bold; " href="reporte/pdf_paciente_usu.php">PACIENTES</a>
      <img style="position: relative; top: -170px; left: 30px;" src="iconos/pdf.png" width="70"
title="click aqui"/>
  </button>
