                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="citas_general"><span class="fa fa-circle-o">&nbsp;</span>General </a>
                                </li>
                                <li>
                                    <a href="citas_asignada"><span class="fa fa-circle-o">&nbsp;</span>Asignada </a>
                                </li>
                                <li>
                                    <a href="citas_atendida"><span class="fa fa-circle-o">&nbsp;</span>Atendida</a>
                                </li>
